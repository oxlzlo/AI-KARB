...
| <div>- 회원가입, 로그인, 아이디/비밀번호 찾기 구현<div>- 동일광고 관련 조회 기능 구현</div> <div>- 지적관련 관련 조회, 추가, 삭제, 저장 기능 구현</div><div>- 인풋, 타이머 공통 컴포넌트 구현</div></div>                                                                                                      | <div>내용</div>                                                                                                      | <div> - 관리자 대시보드 및 사용자 대시보드 구현<div> - 대시보드 모든 요소들 컴포넌트화</div><div> - 작업자 관리 및 작업 배분 구현</div><div> - 테이블, 버튼, 스피너, 프로그래스 바 공통 컴포넌트 구현</div></div> |
...
![signup](https://github.com/user-attachments/assets/ed0019d8-f25b-498c-b1b3-0b137ab626af)
...
![findpwd](https://github.com/user-attachments/assets/f58a3ff8-f3f1-47dc-abae-d021295bd990)
...
![dashboard-home](https://github.com/user-attachments/assets/1fe8fb22-e9a6-4ce8-ba6d-04c5d920e3aa)

- 관리자는 관리자 전용 대시보드에서 해당하는 차수 동안 직원들의 진행 상황을 한 눈에 알아 볼 수 있어요❗️

![dashboard-admin](https://github.com/user-attachments/assets/0871cc35-2a0c-48c9-bb04-b294129d4652)
...
![issueRe](https://github.com/user-attachments/assets/b185e1d2-9e96-46bd-8a82-6424ff5d2bd7)
...
![mytask](https://github.com/user-attachments/assets/8e0ebcb7-7adb-4af6-96e0-31fa7f3bcc1a)
...
![mypageForm](https://github.com/user-attachments/assets/3ed9e7dc-3fa0-4478-a3c3-8333b283a9b2)

![mypagePass](https://github.com/user-attachments/assets/d5b218eb-887f-4d68-9250-549381babc8d)
...
![signureq](https://github.com/user-attachments/assets/0944290d-a125-4567-90b1-58138fad780f)
...
![manageUser](https://github.com/user-attachments/assets/f8ef194d-0322-4ca7-b957-b20900307a79)
...
![manageEmp](https://github.com/user-attachments/assets/8911ca62-53c1-454e-9754-b9baea51c12d)
...
![divideWork](https://github.com/user-attachments/assets/b2091067-c768-4f57-a5b4-025d74b0a06a)
